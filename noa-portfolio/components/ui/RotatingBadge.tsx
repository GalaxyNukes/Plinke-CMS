...
export function RotatingBadge() {
  ...
  return (
    <div className="w-28 h-28 relative cursor-pointer group">
      ...
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-11 h-11 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform"
