    ...
    defineField({
      ...
      fields: [
        ...
        },
        {
          ...
          type: "number",
          initialValue: 4.5,
          description: "Zoom — how far the camera is from the character. Smaller = closer. Try 2–8. Default: 4.5",
        },
        {
          name: "cameraHeight",
          title: "Camera Height",
          type: "number",
          initialValue: 1.0,
          description: "Camera height. 1.0 = mid-body (default). 0.5 = lower / ground. 1.5 = higher / face framing. Try 0.5–2.0.",
        },
        {
          name: "modelScale",
          title: "Model Scale",
