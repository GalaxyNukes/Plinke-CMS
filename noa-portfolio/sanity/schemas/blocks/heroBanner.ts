      ...
      fields: [
        {
          ...
          options: {
            list: [
              ...
              { title: "Ribbons — flowing light beams (Stacks-style)", value: "ribbons" },
              { title: "Orbs — aurora blobs (Vento-style)", value: "orbs" },
              { title: "Dust — fine upward particles (Lumina-style)", value: "dust" },
